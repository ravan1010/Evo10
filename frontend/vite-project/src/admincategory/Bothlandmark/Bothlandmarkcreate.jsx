        ...
        await axios.post("http://localhost:5001/api/admin/post",{
         ...
         .then((res) => {
            ...
            if(res.data.message === "post created"){
              alert("post created")
              setTimeout(() => {
                navigate('/bothlandmark/dashboard')
              }, 200);
            }
                ...
                <h2 className="font-bold text-3xl mt-10"  >Create Event</h2>
                    <form action="post" className="items-center w-full p-2 pb-0.5" onSubmit={handleSubmit} >
                        ...
                        <select
                          ...
                          id='Landmark'
                           className="w-full px-3 py-0 border-1 outline-none overflow-scroll mt-1 mb-2.5 h-10"
                           >
                          <option value="">choose Landmark</option>
                          <option value="adminlandmark">on your Landmark</option>
                          <option value="clientslandmark">on clients Landmark</option>
                      </select>
