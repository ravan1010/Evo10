    ...
    <div className='w-screen'>
      ...
      <div className=' flex justify-center'>
          <div className=' m-4 mt-5 flex flex-col '>
            ...
            <div className='flex justify-center'>
            <h1 className=''>clientslandmark</h1>
            </div>
            <hr />
            <div className='flex justify-center mt-4'>
              <Link to='/clientslandmark/productcreate' className=' border-2 mx-1 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-2xl'>Create product</Link>
      ...
      <div className='w-full h-fit flex justify-center bg-amber-50 '>
        <div className='flex flex-col'>
         ...
         <div className='w-full hidden mt-10 p-5 flex-col lg:block md:block' >
          {
